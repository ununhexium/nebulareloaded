...
import net.lab0.nebula.reloaded.opencl.CLGLInteropDemo.GLFWWindow;
...
import static net.lab0.nebula.reloaded.opencl.IOUtil.ioResourceToByteBuffer;
import static net.lab0.nebula.reloaded.opencl.InfoUtil.checkCLError;
import static net.lab0.nebula.reloaded.opencl.InfoUtil.getPlatformInfoStringUTF8;
import static net.lab0.nebula.reloaded.opencl.InfoUtil.getProgramBuildInfoInt;
import static net.lab0.nebula.reloaded.opencl.InfoUtil.getProgramBuildInfoStringASCII;
...
public class Mandelbrot {
  ...
  public Mandelbrot(long platform, CLCapabilities platformCaps, GLFWWindow window, int deviceType, boolean debugGL, int maxIterations) {
    ...
    try {
      ...
      log = GL20.glGetProgramInfoLog(glProgram, glGetProgrami(glProgram, GL_INFO_LOG_LENGTH));
      if (!log.isEmpty()) {
